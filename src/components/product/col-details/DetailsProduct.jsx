  ...
  return (
    <section className="container mx-auto px-4 md:px-0">
      ...
      <div className="grid grid-cols-3 gap-4 font-bold md:grid-cols-[1fr_1.7fr]">
        ...
        <button className="md:col-span-1 col-span-3 flex items-center justify-center gap-x-3 rounded-md bg-orange-primary py-3 text-white transition-all hover:bg-orange-700">
